<%-- 
    Document   : ruta
    Created on : Mar 15, 2020, 1:00:57 PM
    Author     : yeison.ariel
--%>
										...
										<div>
                                                                                    ...
                                                                                    <form action="rutaControlador" method="POST">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div class="col-sm-10">
                                                                                                <input type="text" name="txtdiR" class="form-control" placeholder="Ingresar ID">
                                                                                            </div>
                                                                                        </div>
                                                                                        <br/><br/>
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div class="col-sm-10">
                                                                                                <input type="text" name="txtNomR" class="form-control" placeholder="Ingresar Nombre">
                                                                                            </div>
                                                                                        </div>
                                                                                                                                        <div class="form-group">
                                                                                            <label class="col-sm-2 control-label no-padding-right">
                                                                                            ...
                                                                                            <div class="col-sm-10">
                                                                                                <input type="text" name="txtRv" class="form-control" placeholder="Ingresar ID Vehiculo">
                                                                                            </div>
                                                                                        </div>
                                                                                        <br/><br/>
