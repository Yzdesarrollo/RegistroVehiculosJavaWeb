<%-- 
    Document   : contrato
    Created on : Mar 14, 2020, 9:06:52 PM
    Author     : yeison.ariel
--%>
										...
										<div>
                                                                                    ...
                                                                                    <form action="contratoControlador" method="POST">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div class="col-sm-10">
                                                                                                <input type="text" name="txtId" class="form-control" placeholder="Ingresar ID">
                                                                                            </div>
                                                                                        </div>
                                                                                        <br/><br/>
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div class="col-sm-10">
                                                                                                <input type="text" name="txtTC" class="form-control" placeholder="Ingresar ID vehiculo">
                                                                                            </div>
                                                                                        </div>
                                                                                        <br/><br/>
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div class="col-sm-10">
                                                                                                <input type="text" name="txtIdC" class="form-control" placeholder="Ingresar conductor">
                                                                                            </div>
                                                                                        </div>
                                                                                        <br><br>
