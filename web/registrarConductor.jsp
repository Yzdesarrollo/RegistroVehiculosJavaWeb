<%-- 
    ...
    Created on : Mar 14, 2020, 7:17:57 PM
    Author     : yeison.ariel
--%>
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<div>
                                                                                    ...
                                                                                    <form action="tipoCondControlador" method="POST">
                                                                                        <div class="form-group">
                                                                                            <label class="col-sm-2 control-label no-padding-right">
                                                                                                ID Conductor:
                                                                                            </label>
                                                                                            <div class="col-sm-10">
                                                                                                <input type="text" name="txtTc" class="form-control" placeholder="Ingresar ID">
                                                                                            </div>
                                                                                        </div>
                                                                                        <br/><br/>
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div class="col-sm-10">
                                                                                                <input type="text" name="txtNomTc" class="form-control" placeholder="Ingrese su nombre completo">
                                                                                            </div>
                                                                                        </div>
                                                                                        <br><br>
