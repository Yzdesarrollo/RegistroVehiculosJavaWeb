...
public class vehiculoControlador extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String REF = request.getParameter("txtref");
        int MODELO = Integer.parseInt(request.getParameter("txtmodel"));
        int ITV = Integer.parseInt(request.getParameter("txtitv"));
        ...
        if(vehiculoDAO.insertarV(veh)){
            
            request.setAttribute("mensaje", "Vehiculo registrado exitosamente");
        }
        else 
        {
